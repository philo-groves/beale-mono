...
- Research agents now prefer several cohesive, medium-sized runbooks over one giant proof controller. Explicit phase management and changes in objective, target state, prerequisites, evidence contract, or cleanup trigger sibling runbooks, while stable artifact entry cells still absorb small implementation iterations without per-tweak churn.
