...
export const DEFAULT_MATHEMATICS_RESEARCH_PROFILE: ResearchProfile = {
  ...
  agent: {
    ...
    memoryInstructions: [
      ...
      "Record conjectures as leads and promote the same stable claims to theorem or counterexample findings when evidence supports them. Reusable definitions, techniques, references, and trajectories remain knowledge memory.",
    ],
    runbookInstructions: [
