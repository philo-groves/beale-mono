...
export function providerIconKind(provider: string | null | undefined): ProviderIconKind {
  ...
  if (
    ['openai', 'openai-codex', 'codex'].includes(normalized) ||
...
type IconProps = Omit<SVGProps<SVGSVGElement>, 'height' | 'width'> & { size: number };

function OpenAIIcon({ size, ...props }: IconProps): JSX.Element {
  return (
...
function AnthropicIcon({ size, ...props }: IconProps): JSX.Element {
  return (
    <svg {...props} fill="currentColor" fillRule="evenodd" height={size} viewBox="0 0 24 24" width={size} xmlns="http://www.w3.org/2000/svg">
...
function XAIIcon({ size, ...props }: IconProps): JSX.Element {
  return (
    <svg {...props} fill="currentColor" fillRule="evenodd" height={size} viewBox="0 0 24 24" width={size} xmlns="http://www.w3.org/2000/svg">
