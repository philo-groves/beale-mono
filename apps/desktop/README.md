...
- Workspace-scoped Jupyter-format runbooks with whole-run, inclusive range, and per-cell controls; independent content-revision, completed-run, executed-cell, and latest-status metrics; durable cell results; bounded outputs; healthy-runbook guidance; and dedicated app-server tools and Beale sidebar visibility
